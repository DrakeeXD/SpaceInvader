...
function draw() {
  ...
  textSize(20);
  fill("white");
  text("Press SPACEBAR to Shoot the Invaders",60,50)
  text("Score: " + score, 220,  80);
...
function spawnInvaders() {
  if (frameCount % 80 === 0) {
    invader = createSprite(Math.round(random(20, 470)), 0, 20, 20)
